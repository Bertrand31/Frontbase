...
document.addEventListener('DOMContentLoaded', function () {
    var viewport = util.updateViewportDimensions(window, document);
    console.log(viewport);
});

},{"./utilities":3,"svgxuse":1}],3:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    updateViewportDimensions: function updateViewportDimensions(win, doc) {
